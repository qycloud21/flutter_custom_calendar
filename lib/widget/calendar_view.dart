...
class CalendarContainerState extends State<CalendarContainer>
  ...
  void initState() {
    ...
    expand = calendarProvider.expandStatus?.value ?? false;
        ...
        setState(() {
          ...
          if (expand) {
            ...
            int lineCount = DateUtil.getMonthViewLineCount(
                calendarProvider.calendarConfiguration?.nowYear ?? 0,
                calendarProvider.calendarConfiguration?.nowMonth ?? 0,
                calendarProvider.calendarConfiguration?.offset ?? 0);
            totalHeight = (calendarProvider.calendarConfiguration?.itemSize ??
                        0) *
                    (lineCount) +
                (calendarProvider.calendarConfiguration?.verticalSpacing ?? 0) *
                    (lineCount - 1);
    ...
    itemHeight = calendarProvider.calendarConfiguration?.itemSize ?? 0;
    ...
    return Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
           ...
           */
          if (calendarProvider
                  .calendarConfiguration?.weekBarItemWidgetBuilder !=
              null)
